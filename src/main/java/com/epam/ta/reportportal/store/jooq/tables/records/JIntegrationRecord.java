...
public class JIntegrationRecord extends UpdatableRecordImpl<JIntegrationRecord>
		implements Record5<Integer, Integer, Integer, Object, Timestamp> {

	private static final long serialVersionUID = 566616677;
     ...
     */
    @Override
	public Row5<Integer, Integer, Integer, Object, Timestamp> fieldsRow() {
     ...
     */
    @Override
	public Row5<Integer, Integer, Integer, Object, Timestamp> valuesRow() {
     ...
     */
    @Override
	public JIntegrationRecord value2(Integer value) {
		setProjectId(value);
        return this;
    }
     ...
     */
    @Override
	public JIntegrationRecord values(Integer value1, Integer value2, Integer value3, Object value4, Timestamp value5) {
		value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
	public JIntegrationRecord(Integer id, Integer projectId, Integer type, Object params, Timestamp creationDate) {
		super(JIntegration.INTEGRATION);
