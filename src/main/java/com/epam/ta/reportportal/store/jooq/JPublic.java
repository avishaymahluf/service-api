...
public class JPublic extends SchemaImpl {
	...
	private static final long serialVersionUID = -372027780;
	...
	/**
	 * The table <code>public.issue_statistics_issue_group</code>.
	 */
	public final JIssueStatisticsIssueGroup ISSUE_STATISTICS_ISSUE_GROUP = com.epam.ta.reportportal.store.jooq.tables.JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP;

	/**
	 * The table <code>public.issue_statistics_issue_type</code>.
	 */
	public final JIssueStatisticsIssueType ISSUE_STATISTICS_ISSUE_TYPE = com.epam.ta.reportportal.store.jooq.tables.JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE;
    ...
    private final List<Table<?>> getTables0() {
        return Arrays.<Table<?>>asList(
            ...
            JIssue.ISSUE, JIssueGroup.ISSUE_GROUP, JIssueStatistics.ISSUE_STATISTICS,
				JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP, JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE, JIssueTicket.ISSUE_TICKET,
