...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements
																	  Record13<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Long> {

	private static final long serialVersionUID = 723881605;
	...
	/**
	 * Setter for <code>public.launch.execution_statistics</code>.
	 */
	...
	/**
	 * Getter for <code>public.launch.execution_statistics</code>.
	 */
     ...
     */
    @Override
	public Row13<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Long> fieldsRow() {
     ...
     */
    @Override
	public Row13<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Long> valuesRow() {
	...
	public Field<Long> field13() {
		return JLaunch.LAUNCH.EXECUTION_STATISTICS;
	}
     ...
     */
    @Override
	public JLaunchRecord value13(Long value) {
	...
	public JLaunchRecord values(Long value1, String value2, Long value3, Long value4, String value5, String value6, Timestamp value7,
			Timestamp value8, Integer value9, Timestamp value10, JLaunchModeEnum value11, JStatusEnum value12, Long value13) {
		value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
	...
	public JLaunchRecord(Long id, String uuid, Long projectId, Long userId, String name, String description, Timestamp startTime,
			Timestamp endTime, Integer number, Timestamp lastModified, JLaunchModeEnum mode, JStatusEnum status, Long executionStatistics) {
		super(JLaunch.LAUNCH);
