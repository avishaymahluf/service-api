...
public class Keys {
	...
	public static final UniqueKey<JIssueStatisticsRecord> ISSUE_STATISTICS_LAUNCH_ID_KEY = UniqueKeys0.ISSUE_STATISTICS_LAUNCH_ID_KEY;
	public static final UniqueKey<JIssueStatisticsRecord> ISSUE_STATISTICS_TEST_ITEM_ID_KEY = UniqueKeys0.ISSUE_STATISTICS_TEST_ITEM_ID_KEY;
	public static final UniqueKey<JIssueStatisticsIssueGroupRecord> ISSUE_STATISTICS_ISSUE_GROUP_PK = UniqueKeys0.ISSUE_STATISTICS_ISSUE_GROUP_PK;
	public static final UniqueKey<JIssueStatisticsIssueTypeRecord> ISSUE_STATISTICS_ISSUE_TYPE_PK = UniqueKeys0.ISSUE_STATISTICS_ISSUE_TYPE_PK;
	...
	public static final UniqueKey<JLaunchRecord> LAUNCH_EXECUTION_STATISTICS_KEY = UniqueKeys0.LAUNCH_EXECUTION_STATISTICS_KEY;
	...
	public static final UniqueKey<JTestItemResultsRecord> TEST_ITEM_RESULTS_EXECUTION_STATISTICS_KEY = UniqueKeys0.TEST_ITEM_RESULTS_EXECUTION_STATISTICS_KEY;
	...
	public static final ForeignKey<JIssueStatisticsRecord, JTestItemRecord> ISSUE_STATISTICS__ISSUE_STATISTICS_TEST_ITEM_ID_FKEY = ForeignKeys0.ISSUE_STATISTICS__ISSUE_STATISTICS_TEST_ITEM_ID_FKEY;
	public static final ForeignKey<JIssueStatisticsIssueGroupRecord, JIssueStatisticsRecord> ISSUE_STATISTICS_ISSUE_GROUP__ISSUE_STATISTICS_ISSUE_GROUP_STATISTICS_ID_FKEY = ForeignKeys0.ISSUE_STATISTICS_ISSUE_GROUP__ISSUE_STATISTICS_ISSUE_GROUP_STATISTICS_ID_FKEY;
	public static final ForeignKey<JIssueStatisticsIssueGroupRecord, JIssueGroupRecord> ISSUE_STATISTICS_ISSUE_GROUP__ISSUE_STATISTICS_ISSUE_GROUP_ISSUE_GROUP_ID_FKEY = ForeignKeys0.ISSUE_STATISTICS_ISSUE_GROUP__ISSUE_STATISTICS_ISSUE_GROUP_ISSUE_GROUP_ID_FKEY;
	public static final ForeignKey<JIssueStatisticsIssueTypeRecord, JIssueStatisticsRecord> ISSUE_STATISTICS_ISSUE_TYPE__ISSUE_STATISTICS_ISSUE_TYPE_STATISTICS_ID_FKEY = ForeignKeys0.ISSUE_STATISTICS_ISSUE_TYPE__ISSUE_STATISTICS_ISSUE_TYPE_STATISTICS_ID_FKEY;
	public static final ForeignKey<JIssueStatisticsIssueTypeRecord, JIssueTypeRecord> ISSUE_STATISTICS_ISSUE_TYPE__ISSUE_STATISTICS_ISSUE_TYPE_ISSUE_TYPE_ID_FKEY = ForeignKeys0.ISSUE_STATISTICS_ISSUE_TYPE__ISSUE_STATISTICS_ISSUE_TYPE_ISSUE_TYPE_ID_FKEY;
	...
	public static final ForeignKey<JLaunchRecord, JExecutionStatisticsRecord> LAUNCH__EXECUTION_STATISTICS_FK = ForeignKeys0.LAUNCH__EXECUTION_STATISTICS_FK;
	...
	public static final ForeignKey<JTestItemResultsRecord, JExecutionStatisticsRecord> TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_EXECUTION_STATISTICS_FKEY = ForeignKeys0.TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_EXECUTION_STATISTICS_FKEY;
    ...
    private static class UniqueKeys0 {
		...
		public static final UniqueKey<JIssueStatisticsRecord> ISSUE_STATISTICS_LAUNCH_ID_KEY = Internal.createUniqueKey(
				JIssueStatistics.ISSUE_STATISTICS, "issue_statistics_launch_id_key", JIssueStatistics.ISSUE_STATISTICS.LAUNCH_ID);
		public static final UniqueKey<JIssueStatisticsRecord> ISSUE_STATISTICS_TEST_ITEM_ID_KEY = Internal.createUniqueKey(
				JIssueStatistics.ISSUE_STATISTICS, "issue_statistics_test_item_id_key", JIssueStatistics.ISSUE_STATISTICS.TEST_ITEM_ID);
		public static final UniqueKey<JIssueStatisticsIssueGroupRecord> ISSUE_STATISTICS_ISSUE_GROUP_PK = Internal.createUniqueKey(
				JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP, "issue_statistics_issue_group_pk",
				JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP.STATISTICS_ID,
				JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP.ISSUE_GROUP_ID
		);
		public static final UniqueKey<JIssueStatisticsIssueTypeRecord> ISSUE_STATISTICS_ISSUE_TYPE_PK = Internal.createUniqueKey(
				JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE, "issue_statistics_issue_type_pk",
				JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE.STATISTICS_ID,
				JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE.ISSUE_TYPE_ID
		);
		...
		public static final UniqueKey<JLaunchRecord> LAUNCH_EXECUTION_STATISTICS_KEY = Internal.createUniqueKey(
				JLaunch.LAUNCH, "launch_execution_statistics_key", JLaunch.LAUNCH.EXECUTION_STATISTICS);
		...
		public static final UniqueKey<JTestItemResultsRecord> TEST_ITEM_RESULTS_EXECUTION_STATISTICS_KEY = Internal.createUniqueKey(
				JTestItemResults.TEST_ITEM_RESULTS, "test_item_results_execution_statistics_key",
				JTestItemResults.TEST_ITEM_RESULTS.EXECUTION_STATISTICS
		);
    ...
    private static class ForeignKeys0 {
		...
		public static final ForeignKey<JIssueStatisticsRecord, JTestItemRecord> ISSUE_STATISTICS__ISSUE_STATISTICS_TEST_ITEM_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_PK, JIssueStatistics.ISSUE_STATISTICS,
						"issue_statistics__issue_statistics_test_item_id_fkey", JIssueStatistics.ISSUE_STATISTICS.TEST_ITEM_ID
				);
		public static final ForeignKey<JIssueStatisticsIssueGroupRecord, JIssueStatisticsRecord> ISSUE_STATISTICS_ISSUE_GROUP__ISSUE_STATISTICS_ISSUE_GROUP_STATISTICS_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.PK_ISSUE_STATISTICS,
						JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP,
						"issue_statistics_issue_group__issue_statistics_issue_group_statistics_id_fkey",
						JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP.STATISTICS_ID
				);
		public static final ForeignKey<JIssueStatisticsIssueGroupRecord, JIssueGroupRecord> ISSUE_STATISTICS_ISSUE_GROUP__ISSUE_STATISTICS_ISSUE_GROUP_ISSUE_GROUP_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.ISSUE_GROUP_PK,
						JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP,
						"issue_statistics_issue_group__issue_statistics_issue_group_issue_group_id_fkey",
						JIssueStatisticsIssueGroup.ISSUE_STATISTICS_ISSUE_GROUP.ISSUE_GROUP_ID
				);
		public static final ForeignKey<JIssueStatisticsIssueTypeRecord, JIssueStatisticsRecord> ISSUE_STATISTICS_ISSUE_TYPE__ISSUE_STATISTICS_ISSUE_TYPE_STATISTICS_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.PK_ISSUE_STATISTICS,
						JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE,
						"issue_statistics_issue_type__issue_statistics_issue_type_statistics_id_fkey",
						JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE.STATISTICS_ID
				);
		public static final ForeignKey<JIssueStatisticsIssueTypeRecord, JIssueTypeRecord> ISSUE_STATISTICS_ISSUE_TYPE__ISSUE_STATISTICS_ISSUE_TYPE_ISSUE_TYPE_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.ISSUE_TYPE_PK,
						JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE,
						"issue_statistics_issue_type__issue_statistics_issue_type_issue_type_id_fkey",
						JIssueStatisticsIssueType.ISSUE_STATISTICS_ISSUE_TYPE.ISSUE_TYPE_ID
				);
		...
		public static final ForeignKey<JLaunchRecord, JExecutionStatisticsRecord> LAUNCH__EXECUTION_STATISTICS_FK = Internal.createForeignKey(
				com.epam.ta.reportportal.store.jooq.Keys.PK_EXECUTION_STATISTICS, JLaunch.LAUNCH, "launch__execution_statistics_fk",
				JLaunch.LAUNCH.EXECUTION_STATISTICS
		);
		...
		public static final ForeignKey<JTestItemResultsRecord, JExecutionStatisticsRecord> TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_EXECUTION_STATISTICS_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.PK_EXECUTION_STATISTICS, JTestItemResults.TEST_ITEM_RESULTS,
						"test_item_results__test_item_results_execution_statistics_fkey",
						JTestItemResults.TEST_ITEM_RESULTS.EXECUTION_STATISTICS
				);
